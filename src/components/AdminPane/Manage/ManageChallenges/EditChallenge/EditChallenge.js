...
export class EditChallenge extends Component {
  ...
  validateOverpass(query) {
    ...
    if (lintErrors.length > 0) {
      response.errors = {
        overpassQL: {
          __errors: [this.props.intl.formatMessage(lintErrors[0].message)],
        },
      };
    }
  ...
  finish = async () => {
    ...
    if (this.state.formData.email) {
      try {
        this.props.updateEmail(this.state.formData.email);
      } catch (e) {
  ...
  prepareChallengeDataForForm = () => {
    ...
    challengeData.reviewTaskTags = _isString(challengeData.reviewTaskTags)
  ...
  prepareFormDataForSaving = async () => {
    ...
    if (challengeData.isSourceReadOnly()) {
      ...
      // processing.
      if (challengeData.source === "Local File" && challengeData.localGeoJSON) {
                  ...
                  >
                    <div className="mr-overflow-y-auto mr-max-h-screen80 mr-bg-black-15 mr-m-2 mr-p-4">
                      <TaskPropertyStyleRules {...this.props}>
                        <button
                          className="mr-button mr-button--green mr-mr-4"
                          onClick={() => {
        ...
        <div className="admin__manage__primary-content">
          <div className="admin__manage__header">
            ...
            >
              ...
              >
                <FormattedMessage
                  {...(props.isNewChallenge
                    ? messages.cancelNewChallengeLabel
